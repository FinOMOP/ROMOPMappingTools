...
| ------------------------------- | --------- | ---------------------------------- | -------- |
| ADD_INFO:sourceConceptId        | double    | Source vocabulary concept ID       | not empty, number over 2 billion, must be unique per each sourceCode |
