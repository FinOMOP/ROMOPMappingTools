...
ERROR:
- The sourceCode must be of the format {testName}[{testUnit}]
- The testUnit must be in the quantity_source_unit_conversion.tsv
- Domain of the mapped concept must be 'Measurement'
- The testUnit quantity must agree with the quantity in the vocabularies for the mapped concept


WARNING:
- Same testName with same quantity maps to different concept ids
